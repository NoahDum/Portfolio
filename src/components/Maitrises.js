...
import { FaHtml5, FaCss3Alt, FaSass, FaJsSquare, FaReact, FaGithub, FaHandPointLeft, FaHandPointRight } from 'react-icons/fa';
import Carousel from "react-spring-3d-carousel";
import uuidv4 from "uuid";
import { config } from "react-spring";

export default class Maitrises extends Component {
    state = {
        goToSlide: 0,
        offsetRadius: 2,
        showNavigation: true,
        ...
        },
        {
            ...
            content:
                <div className="element">
                    ...
                    <p>React est un framework Javascript que j'ai appris à comprendre, à utiliser et à maitriser des fonctionnalités telles que les routes ou encore le redux toolkit qui permet de faciliter l'utilisation de React.</p>
                </div>
        },
        {
            key: uuidv4(),
